...
Use this if the categorical variables are in fact known to have ordered relations with the outcome.
```{r}
...
### NOT WORKING YET - How do I lapply with a function that returns a function. TBC.
